      ...
      <div className="flex bg-white rounded-2xl shadow-xl overflow-hidden max-w-4xl w-full m-4">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div><img className="absolute top-25 rounded-full h-80 " src={images} alt="" /></div>
            <div className="absolute h-6 w-auto"></div>
            <div className="mt-auto text-sm">
              <div className="bg-black bg-opacity-60 p-6 rounded-lg">
                <p className="italic text-white">"the way you love the nature is different"</p>
                <p className="mt-3 text-gray-200">
                  <center>from where the gender equality begins
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-10">
          <h2 className="text-3xl font-bold text-gray-800 mb-2 text-center">Welcome back Home Dear</h2>
          <p className="text-gray-500 mb-8 text-center">lets build our dreams together</p>
